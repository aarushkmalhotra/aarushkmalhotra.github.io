    ...
    return (
        <div className="border bg-card rounded-lg p-4 sm:p-6 overflow-hidden relative">
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                ...
                <div className="flex-grow w-full">
                    <div className="flex items-center justify-between">
                        ...
                        <Badge variant="destructive" className="flex-shrink-0">AI Generated</Badge>
                    </div>
            ...
            <div className="text-xs text-muted-foreground mt-4 border-t pt-3">
                <p>
                    <strong>Original Song Credits:</strong> Licensed to YouTube by {audioFile.originalLabel} (on behalf of {audioFile.originalArtist}); [Placeholder for Publishing Rights] and [X] music rights societies.
                </p>
            </div>
